  ...
  return (
    <div className="flex flex-col bg-background min-h-screen">
      ...
      <Case
        ...
        subtitle="تلتزم روايال إنك بتطبيق أعلى المعايير القياسية العالمية (ISO, SGS, REACH, RoHS, STMC, CE, Ten Rings) لضمان الأداء الفائق والسلامة التامة — مرر المؤشر على أي شهادة لقراءة تعريفها الكامل."
      />
    </div>
  );
}
