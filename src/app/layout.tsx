        ...
        <header className="sticky top-0 z-50 w-full bg-white shadow-sm">
          <div className="container mx-auto px-4 h-20 flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center">
              <img src="/images/logo.svg" alt="Royal Ink" className="h-10 object-contain" />
            </Link>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-b border-white/10 pb-12 mb-6">
              ...
              <div className="space-y-6 flex flex-col items-center md:items-start text-center md:text-start">
                <img src="/images/logo-footer-new.svg" alt="Royal Ink" className="h-10" />
                <div className="space-y-4 text-sm text-gray-400">
                  <p className="font-semibold text-gray-300">روايال إنك: دقة في كل طباعة.</p>
                  <p className="leading-relaxed">خراطيش الحبر الفاخرة ومستلزمات الطباعة. نعزز الوضوح ونطيل عمر الطابعة. مستلزمات طباعة سريعة وموثوقة للشركات الجزائرية.</p>
                </div>
                <div className="flex items-center justify-center md:justify-start gap-4 pt-2">
                  <span className="text-sm font-medium">تواصل معنا</span>
                  <div className="flex gap-2">
                    <a href="#" className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-primary hover:scale-110 transition-transform">
              ...
              <div className="space-y-6 flex flex-col items-center md:items-start text-center md:text-start">
                ...
                <div className="space-y-4 text-sm text-gray-400">
                  ...
                  <div className="flex items-start gap-3 justify-center md:justify-start">
                    ...
                    <span>دبي، مدينة العلمة 19001<br/>سطيف، الجزائر</span>
                  </div>
                </div>
              </div>
