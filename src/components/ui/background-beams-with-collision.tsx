...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    ...
    >
      ...
      <div
        ref={containerRef}
        className="absolute bottom-0 w-full inset-x-0 pointer-events-none opacity-0 h-1"
      ></div>
    </div>
  );
};
  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-20 m-auto h-14 w-px rounded-full bg-gradient-to-t from-red-600 via-zinc-400 to-transparent",
